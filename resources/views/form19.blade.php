            ...
            <div class="container bg_color p-lg-3 p-1  ">
                    ...
                    @endif
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class='d-flex d_sm_block'>
                                    <span>Phone: </span><input type="number" name="fdf_phone" class="responsive_input form-control border-none border-0 border-bottom border-dotted shadow-none"  style="width:230px">
                                </div>
                                <div class='d-flex d_sm_block'>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="ms-lg-3 d-flex small_text d_sm_block">
                                ...
                                <input type="date" min="0" name="pi_dob" style="width: 303px"  class="border-bottom border-0  responsive_input bg-transparent border outline-none form-control ms-3">
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered border-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input type="date" name="ei_doh1" class="border-0 form-control"></td>
                                            ...
                                            <td><input type="number" name="ei_workschedule1" class="border-0 form-control"></td>
                                            <td><input type="text" name="ei_workschedule_time_1" class="border-0 form-control"></td>
                                        </tr>
                                        <tr>
                                            <td><input type="date" name="ei_doh2" class="border-0 form-control"></td>
                                            ...
                                            <td><input type="number" name="ei_workschedule2" class="border-0 form-control"></td>
                        ...
                        <div class="ms-lg-4">
                            <div class=" d-flex small_text d_sm_block">
                                ...
                                <input type="date" min="0" name="date_of_hire" style="width: 193px"  class="border-bottom border-0  responsive_input bg-transparent border outline-none form-control ms-lg-3">
                                <span>Date of Termination:</span>
                                <input type="date" min="0" name="date_of_termination" style="width: 193px"  class="border-bottom border-0  responsive_input bg-transparent border outline-none form-control ms-lg-3">
                            </div>
                            <div class=" d-flex small_text d_sm_block">
                        ...
                        <div class="row mt-lg-3">
                            ...
                            <div class="ms-lg-4">
                                <div class=" d-flex d_sm_block small_text">
                                    ...
                                    <input type="number" min="0" name="gross_year_date" style="width: 263px"  class=" responsive_input border-bottom border-0  responsive_input bg-transparent border outline-none form-control ms-lg-3">
                                    </div>
                            </div>
                                    ...
                                    <table class="table table-bordered border-dark">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="annuity_trust_income2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="bonuses2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="cho_allowance2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="commissions_tips2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="rental_income2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="overtime_pay2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="pension_retirement2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="social_security_income2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="social_security_disability2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="spousal_support2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="child_support2" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="workman_compensation2" class="border-0 form-control text-center">  </td>
                                                <td><input type="text" name="workman_compensation3" class="border-0 form-control text-end">  </td>
                                            </tr>

                                            <tr>
                                                <td class="d-flex"><span>Other: </span><input type="text" name="c_others1" class="border-0 form-control"> </td>
                                                <td><input type="text" name="c_others2" class="border-0 form-control text-center">  </td>
                                                <td><input type="number" name="c_others3" class="border-0 form-control text-center">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="c_total_income_other" class="border-0 form-control text-end" value="0">  </td>
                                    ...
                                    <table class="table table-bordered border-dark">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" name="c_total_income_average" class="border-0 form-control text-end" value="0">  </td>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type=numbert" name="ordered_child_support" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>2.</td>
                                        <td class="small_text">Federal Health Savings Plan</td>
                                        <td><input type="number" name="federal_health_saving" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>3.</td>
                                        <td class="small_text">Federal Income Tax</td>
                                        <td><input type="number" name="federal_income_tax" class="border-0 form-control text-end" >  </td>
                                    </tr>
                                    <tr>
                                        <td>4.</td>
                                        <td>
                                        ...
                                        <td class="my-auto"><input type="number" name="health_insurance" class="border-0 form-control text-end" value="0" >  </td>
                                    </tr>

                                    <tr>
                                        <td>5.</td>
                                        <td class="small_text">5. Life, Disability, or Other Insurance Premiums</td>
                                        <td><input type="number" name="life_insurance_premiums" class="border-0 form-control text-end" >  </td>
                                    </tr>
                                    <tr>
                                        <td>6.</td>
                                        <td class="small_text">Medicare</td>
                                        <td><input type="number" name="medicare" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>7.</td>
                                        <td class="small_text"> Retirement, Pension, IRA, or 401(k)</td>
                                        <td><input type="number" name="retirement_pension_ira" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>8.</td>
                                        <td class="small_text">Savings</td>
                                        <td><input type="number" name="savings" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>9.</td>
                                        <td class="small_text">Social Security</td>
                                        <td><input type="number" name="social_security" class="border-0 form-control text-end" >  </td>
                                    </tr>

                                    <tr>
                                        <td>10.</td>
                                        <td class="small_text">Union Dues</td>
                                        <td><input type="number" name="union_dues" class="border-0 form-control text-end" >  </td>
                                    </tr>
                                    <tr>
                                        <td>11.</td>
                                        <td class="d-flex"><span>Other: (Type of Deduction) : </span><input type="text" name="d_other1" class="border-0     w-50 border-bottom"> </td>
                                        <td><input type="number" name="d_other2" class="border-0 form-control text-end" >  </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="text-end fw-bold pe-3">Total Monthly Deductions (Lines 1-11)</td>
                                        <td><input type="number" name="total_monthly_deducations" class="border-0 form-control text-end" value="0">  </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <table class="table table-bordered border-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="advertising2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="car_truck_business2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="commission_wages_fees2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="business_entertainment_travel2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="insurance2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="legal_professional2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="mortgage_rent2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="pension_profit_plans2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="repairs_maintenance2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="supplies2" class="border-0 form-control text-center">  </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="taxes_licanses2" class="border-0 form-control text-center"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="utilities2" class="border-0 form-control text-center"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="b_other3" class="border-0 form-control text-end"></td>
                                    ...
                                    <table class="table table-bordered border-dark">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="alimony_support1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="auto_insurance1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="car_loan_payment1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Cell Phone</td>
                                                <td><input type="number" name="cell_phone1" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="cell_phone2" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="cell_phone3" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="cell_phone4" class="border-0 form-control text-end"></td>
                                            </tr>

                                            <tr>
                                                <td>Child Support (not deducted from pay)</td>
                                                <td><input type="number" name="child_support1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="clothing_shoes1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="credit_card_payment1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Dry Cleaning</td>
                                                <td><input type="number" name="dry_cleaning1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Electric</td>
                                                <td><input type="number" name="electric1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="food1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Fuel</td>
                                                <td><input type="number" name="fuel1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Gas (for home)</td>
                                                <td><input type="number" name="gas1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="health_insurance1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>HOA</td>
                                                <td><input type="number" name="hoa1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="home_insurance1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Home Phone</td>
                                                <td><input type="number" name="home_phone1" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="home_phone2" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="home_phone3" class="border-0 form-control text-end"></td>
                                                <td><input type="number" name="home_phone4" class="border-0 form-control text-end"></td>
                                            </tr>

                                            <tr>
                                                <td>Internet/Cable</td>
                                                <td><input type="number" name="internet_cable1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Lawn Care</td>
                                                <td><input type="number" name="lawn_care1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="membership_fees1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="mortgage_rent1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Pest Control</td>
                                                <td><input type="number" name="pest_control1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Pets</td>
                                                <td><input type="number" name="pets1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Pool Service</td>
                                                <td><input type="number" name="pool_service1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Student Loans</td>
                                                <td><input type="number" name="student_loans1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="unreimbursed_medical1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                <td>Water</td>
                                                <td><input type="number" name="water1" class="border-0 form-control text-end"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="a_other2" class="border-0 form-control text-end">  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="a_total_monthly_expenses1" class="border-0 form-control text-end">  </td>
                                ...
                                <table class="table table-bordered border-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="child_dob1" class="border-0 form-control text-center"></td>
                                            <td><input type="date" name="dob_child_living1" class="border-0 form-control text-center"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="child_dob2" class="border-0 form-control text-center"></td>
                                            <td><input type="date" name="dob_child_living2" class="border-0 form-control text-center"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="child_dob3" class="border-0 form-control text-center"></td>
                                            <td><input type="date" name="dob_child_living3" class="border-0 form-control text-center"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="child_dob4" class="border-0 form-control text-center"></td>
                                            <td><input type="date" name="dob_child_living4" class="border-0 form-control text-center"></td>
                               ...
                               <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="cellular_phone1" class="border-0 form-control text-center"></td>
                                        <td><input type="number" name="cellular_phone2" class="border-0 form-control text-center"></td>
                                        <td><input type="number" name="cellular_phone3" class="border-0 form-control text-center"></td>
                                        <td><input type="number" name="cellular_phone4" class="border-0 form-control text-center"></td>
                                    </tr>
                                    ...
                                    <table class="table table-bordered border-dark">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="age1" class="border-0 form-control text-center"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="age2" class="border-0 form-control text-center"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="age3" class="border-0 form-control text-center"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="age4" class="border-0 form-control text-center"></td>
                                ...
                                <table class="table table-bordered border-dark">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value1" class="border-0  w-100 text-end">
                                                 </div>
                                            </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed1" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value1" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value2" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed2" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value2" class="border-0 w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value3" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed3" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value3" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value4" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed4" class="border-0 w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value4" class="border-0 w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value5" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed5" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value5" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value6" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed6" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value6" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value7" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed7" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value7" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value8" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed8" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value8" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value9" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed9" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value9" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value10" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed10" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value10" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value11" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed11" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value11" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value12" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed12" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value12" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value13" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed13" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value13" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value14" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed14" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value14" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="gross_value15" class="border-0  w-100 text-end">
                                                </div>
                                             </td>
                                            <td class="px-2">-</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="total_amount_owed15" class="border-0  w-100 text-end">
                                                </div>
                                            </td>
                                            <td class="px-2">=</td>
                                            <td>
                                                <div class="d-flex w-100 mx-auto">
                                                    <span>$</span><input type="number" name="net_value15" class="border-0   w-100 text-end">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="2" class="small_text text-center">Total Value of Assets (add lines 1-15)</td>
                                             <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="c_total_assets1"
                                                    class="border-0  w-100 text-end" value="0">
                                            </div> </td>
                                            <td class="px-2">-</td>
                                            <td> <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="c_total_assets2"
                                                    class="border-0  w-100 text-end" value="0">
                                            </div></td>
                                            <td class="px-2">=</td>
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="c_total_assets3"
                                                    class="border-0   w-100 text-end" value="0">
                                            </div></td>
                                            <td></td>
                                        </tr>
                                ...
                                <table class="table table-bordered border-dark">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount1"
                                        ...
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount2"
                                                    class="border-0   w-100  "  >
                                            </div></td>
                                            <td><input type="text" name="account_name2" class="border-0 form-control "></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount3"
                                                    class="border-0   w-100  " >
                                            </div></td>
                                            <td><input type="text" name="account_name3" class="border-0 form-control "></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount4"
                                                    class="border-0   w-100  "  >
                                            </div></td>
                                            <td><input type="text" name="account_name4" class="border-0 form-control "></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount5"
                                                    class="border-0   w-100  " >
                                            </div></td>
                                            <td><input type="text" name="account_name5" class="border-0 form-control "></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_amount6"
                                                    class="border-0 w-100">
                                            </div></td>
                                            <td><input type="text" name="account_name6" class="border-0 form-control "></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>  <div class="d-flex w-100 mx-auto">
                                                <span>$</span><input type="number" name="total_unsecured_debt"
                                                    class="border-0 w-100">
                                            </div></td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="ms-lg-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11"> As of the date of today, the attorney has been paid a total of <span>$<input type="number" name="total_of_behalf" class="responsive_input  border-0 border-bottom"></span>on my behalf.</div>
                            </div>

                            <div class="row">
                                <div class="col-lg-1">3.</div>
                                <div class="col-lg-11"> I have a credit with my attorney in the amount of  <span>$<input type="number" name="credit_attorney" class=" responsive_input border-0 border-bottom w-50"></span ></div>
                            </div>

                            <div class="row">
                                <div class="col-lg-1">4.</div>
                                <div class="col-lg-11"> I currently owe my attorney a total of <span>$<input type="number" class="  border-0 border-bottom w-50 responsive_input responsive_input" name="currently_total" style="max-width:506px !important"></span></div>
                            </div>
                            <div class="row">
                                <div class="col-lg-1">5.</div>
                                <div class="col-lg-11">I owe my prior attorney a total of  <span>$<input type="number" class="  border-0 border-bottom w-50 responsive_input responsive_input" name="prior_total" style="max-width:541px !important"></span ></div>
                            </div>
                        </div>
                ...
                <section class="section_area row page1 bg-white pt-5 p-lg-5 pe-2 pe-lg-5 p-lg-3 m-3 mt-4  pt-lg-5 pt-4" id="eighth_section">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="ps-lg-4">That on (date) <input type="date" name="general_financial_disclosure" class="border-0 border-bottom"> <span>service of the General Financial Disclosure Form was made to the following interested parties in the following manner:</span></div>
                        <div>
