                ...
                <section class="section_area p-5" id="first_section">
                        ...
                        <div>
                            <div class="d-flex d_sm_block">
                                ...
                                {{-- <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="plaintiff_name" style="width:1070px;"> --}}
                                    <select class="form-select form-control border-0 border-bottom ms-lg-2 responsive_input" name="court.family/both" style="width:1060px;">
                            ...
                            <div class="d-flex d_sm_block">
                                <span>Case Name: </span>
                                <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="case" style="width:1075px;">
                            </div>
                            <div class="d-flex d_sm_block">
                                <span>Case Number:</span>
                                <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="case number" style="width:1057px;">
                            </div>
                            <div>
                    ...
                    <div class="border border-dark p-1 row">
                         <div class="col-lg-6 border-end border-dark p-3 small_text">
                            ...
                            <div>Name <input type="text" name="1.1" id="" class="border-0 border-bottom responsive_input"  style="width:512px;"></div>
                            <div>Street Address <input type="text" name="1.2" id="" class="border-0 border-bottom responsive_input"  style="width:452px;"></div>
                            <div>Town/City, State, Zip <input type="text" name="1.3" id="" class="border-0 border-bottom responsive_input"  style="width:413px;"></div>
                            <div>Mailing Address, if different <input type="text" name="1.4" id="" class="border-0 border-bottom responsive_input"  style="width:365px;"></div>
                            <div>Telephone Number: <input type="text" name="1.10" id="" class="border-0 border-bottom responsive_input"  style="width:418px;"></div>
                            <div>Date of Birth <input type="text" name="1.5" id="" class="border-0 border-bottom responsive_input"  style="width:465px;"></div>
                            <div>Social Security Number <input type="text" name="1.6" id="" class="border-0 border-bottom responsive_input"  style="width:395px;"></div>
                            <div>Highest Grade or Degree Completed <input type="text" name="1.7" id="" class="border-0 border-bottom responsive_input"  style="width:305px;"></div>
                            <div>Date of Marriage <input type="text" name="1.8" id="" class="border-0 border-bottom responsive_input"  style="width:440px;"></div>
                            <div>Date of Separation or Divorce <input type="text" name="1.9" id="" class="border-0 border-bottom responsive_input" style="width:352px;"></div>
                            <div>2. Children born to, or adopted by, the Parties (Full Name, DOB, and SSN)</div>
                            <div> <input type="text" name="2.1" id="" class="border-0 border-bottom w-100 responsive_input" ></div>
                            <div> <input type="text" name="2.2" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                            <div> <input type="text" name="2.3" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                            <div> <input type="text" name="2.4" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                            <div class=" d-flex d_sm_block">2a. Number of people currently living in household including self: <input type="text" name="2a.1" id="" class="border-0 border-bottom responsive_input" style="width:120px;"></div>
                            <div class="  ">3. Employment Information
                                Name, Address, and Phone Number of Employer</div>
                                <div> <input type="text" name="3.1" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                                <div> <input type="text" name="3.2" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                                <div> <input type="text" name="3.3" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                                <div>Date and Place of Last Employment</div>

                                <div> <input type="text" name="3.4" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                                <div> <input type="text" name="3.5" id="" class="border-0 border-bottom w-100 responsive_input"></div>
                                <div>Job Skills</div>

                                <div> <input type="text" name="tr3.6" class="border-0 border-bottom w-100 responsive_input"></div>
                         </div>
                        <div class="col-lg-6  p-3 small_text">

                            <div class=" fw-bold">4. Monthly Income - Miscellaneous</div>
                            <div class=" d-flex justify-content-between d_sm_block">AFDC, TANF, and Food Stamps <span>$<input type="text" name="4.1" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Other Public Assistance <span>$<input type="text" name="4.2" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Children's Income <span>$<input type="text" name="4.3" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Child Support <span>$<input type="text" name="4.4" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">5. Monthly Income Before Taxes</div>
                            <div class=" d-flex justify-content-between d_sm_block">Base Pay from Salary, Wages <span>$<input type="text" name="5.1" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Overtime and Shift Differential <span>$<input type="text" name="5.2" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Commissions, Tips, Bonuses <span>$<input type="text" name="5.3" id="" class="border-0 border-bottom responsive_input" ></span> </div>
                            <div class=" d-flex justify-content-between d_sm_block">Part-time Employment <span>$<input type="text" name="5.4" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Self-employment <span>$<input type="text" name="5.5" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Unemployment and Veteran's Benefits <span>$<input type="text" name="5.6" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Disability, Workers' Compensation <span>$<input type="text" name="5.7" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Pension and Retirement Benefits <span>$<input type="text" name="5.8" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Social Security Benefits (SSA) <span>$<input type="text" name="5.9" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Interest and Dividends <span>$<input type="text" name="5.10" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Trust and Other Investment Income <span>$<input type="text" name="5.11" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Rental Income and Business Profits <span>$<input type="text" name="5.12" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">All other sources </div>
                            <div class=" d-flex justify-content-between d_sm_block"><input type="text" name="5.15" id="" class="border-0 border-bottom responsive_input"  style="width:212px;"> <span>$<input type="text" name="5.13" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class="d-flex justify-content-between fw-bold d_sm_block">Total Section 5 Monthly Income <span>$<input type="text" name="5.14" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div>6. Monthly Expenses</div>
                            <div class=" d-flex justify-content-between d_sm_block">Court Ordered Support for Others <span>$<input type="text" name="6.1" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">State Income Taxes <span>$<input type="text" name="6.2" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Mandatory Pension <span>$<input type="text" name="6.3" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">50% of actual self-employment taxes paid <span>$<input type="text" name="6.4" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Health Insurance for Parties' Children <span>$<input type="text" name="6.5" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class=" d-flex justify-content-between d_sm_block">Day Care for Parties' Children <span>$<input type="text" name="6.6" id="" class="border-0 border-bottom responsive_input" ></span></div>
                            <div class="fw-bold d-flex justify-content-between d_sm_block">Total Section 6 Monthly Expenses <span>$<input type="text" name="6.6" id="" class="border-0 border-bottom responsive_input"></span></div>
                    ...
                    <div class="row small_text">
                        ...
                        <div class="col-lg-3">
                            <div class="w-100">$<input type="text" name="7.1" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">$<input type="text" name="7.10" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.19" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    ...
                    <div class="row small_text">
                        ...
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.2" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.11" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.20" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    ...
                    <div class="row small_text">
                        ...
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.3" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.12" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.21" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    ...
                    <div class="row small_text">
                        ...
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.4" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.13" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.22" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Furniture and Appliances</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.5" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.14" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.23" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Checking Accounts</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.6" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.15" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.24" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Investments</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.7" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.16" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.25" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Life Insurance</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.8" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.17" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.26" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Business Interests</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.9" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.18" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.27" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Pensions</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.28" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.30" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.32" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
                    <div class="row small_text">
                        <div class="col-lg-2">Retirement Accounts</div>
                        <div class="col-lg-3">
                            <div class="w-100"> $<input type="text" name="7.29" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="w-100">  $<input type="text" name="7.31" id="" class="border-0 border-bottom responsive_input w-96" > </div>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="7.33" id="" class="border-0 border-bottom responsive_input w-100" >
                        </div>
                    </div>
               ...
               <section class="section_area p-5" id="second_section">
                    ...
                    <div class="row">
                         <div>
                            <div class="d-flex d_sm_block">
                                <span>Case Name: </span>
                                <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="case1" style="width:1075px;">
                            </div>
                            <div class="d-flex d_sm_block">
                                <span>Case Number:</span>
                                <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="case number1" style="width:1057px;">
                            </div>
                            <div class="fw-bold border-bottom mb-1"> FINANCIAL AFFIDAVIT </div>
                            <div class="small_text border-top pb-2 border-dark">8. Additional Assets - If you have an interest in any property which is held solely by or jointly with any other person or entity, and which has not already been disclosed, or if you are owed money from any source, please explain</div>
                            <input type="text" class="border-none border-0 border-bottom responsive_input w-100  responsive_input" name="8.1">

                             <div class="row small_text">
                                <div class="col-lg-6 ">

                                <div>9. Tax Return Information</div>
                                <div class=" d-flex d_sm_block">Year of last return filed <span><input type="text" name="Year of last return filed" id="" class="border-0 border-bottom responsive_input" style="width:420px;"></span></div>
