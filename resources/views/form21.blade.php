            ...
            <div class="container bg_color p-lg-3 p-1  ">
                ...
                <section class="section_area  row page1 bg-white pt-5 p-lg-5 pe-2 pe-lg-5 p-lg-3 m-3 mt-4  pt-lg-5 pt-4"
                    ...
                    <div class="col-lg-10 mx-auto">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="ps-lg-3 border-end border-dark">
                                    ...
                                    <div class="fw-bold overflow-auto">
                                        ...
                                        <a href="https://www.wicourts.gov/forms1/circuit/index.htm"
                                            target="_blank">https://www.wicourts.gov/forms1/circuit/index.htm</a>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-dark">
                                        <tbody>
                                            <tr>
                                                <td class="w-50">Enter the name of the county in which this case is
                                                    filed.</td>
                                                <td>
                                                    <div class="small_text">STATE OF WISCONSIN, CIRCUIT COURT,</div>
                                                    <input type="text" name="noc1" class="border-0 border-bottom">
                                                    COUNTY
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="small_text">On the far right, check Petitioner/Joint
                                                    Petitioner A or Respondent/Joint Petitioner B.</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="small_text">Enter the case number.
                                                    <div><input type="text" name="case_number1" class="border-0  ">
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="ps-2">
                            ...
                            of a Joint Petition. Failure by either
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-10 d-flex d_sm_block">
                                ...
                                <div><input type="text" min="0" name="gi_ssnumber1"
                                        class="border-0 p-0 m-0 border-bottom footer_field w-100 responsive_input"
                                        style="min-width:  300px !important"></div>
                            </div>
                        </div>
                        <div class="row mt-1">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-10 d-flex  ">
                                <div> <input type="checkbox" min="0" name="gi_payroll_office1"
                                        class="border-0 p-0 m-0 border-bottom footer_field w-100"></div>
                                <div class="fw-bold ps-3"> Same as employer</div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="2" class="w-50 text-center bg-secondary"> This person helps
                                            pay expenses</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship1"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship2"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship3"
                                                class="border-0 form-control"></td>
                ...
                <section class="section_area row page1 bg-white pt-5 p-lg-5 pe-2 pe-lg-5 p-lg-3 m-3 mt-4  pt-lg-5 pt-4"
                    ...
                    <div class="col-lg-10 mx-auto">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship4"
                                                class="border-0 form-control"></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help4"
                                                value="Yes" class=""></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help4"
                                                value="No" class=""></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship5"
                                                class="border-0 form-control"></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help5"
                                                value="Yes" class=""></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help5"
                                                value="No" class=""></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship6"
                                                class="border-0 form-control"></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help6"
                                                value="Yes" class=""></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help6"
                                                value="No" class=""></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship7"
                                                class="border-0 form-control"></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help7"
                                                value="Yes" class=""></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help7"
                                                value="No" class=""></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="my_relationship8"
                                                class="border-0 form-control"></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help8"
                                                value="Yes" class=""></td>
                                        <td class="mx-auto text-center"><input type="radio" name="my_help8"
                                                value="No" class=""></td>
                                    </tr>
                        ...
                        <div><input type="checkbox" name="mi_weekly_checkbox" id=""> weekly -multiply weekly
                            income by 4.33 <input type="checkbox" name="mi_other_weekly_checkbox" id="">
                            every other week (bi-weekly) multiply bi-weekly income by 2.17</div>
                        <div><input type="checkbox" name="mi_monthly_checkbox" id=""> monthly <input
                                type="checkbox" name="mi_monthly_multiply_checkbox" id=""> twice a
                            month-multiply semi-monthly income by 2</div>
                        <div class="table-responsive">
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    <tr>
                                        <td colspan="3" class="bg-secondary">MONTHLY GROSS INCOME</td>
                                    </tr>
                                    <tr>
                                        <td>1.</td>
                                        <td>Gross <b>monthly</b> income (before taxes and deductions) from salary and
                                            wages, including commissions, allowances and overtime. (See above how to
                                            calculate.)</td>
                                    ...
                                    <tr>
                                        <td>18.</td>
                                        <td>Medicare</td>
                                        <td><input type="text" name="md_medicare" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>19.</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="md_other1" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>27.</td>
                                        <td><input type="text" name="md_other2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="md_other3" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>28</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end h5">MONTHLY NET INCOME (<span class="small_text">subtract
                                                line 28 from line 13</span>)</td>
                                        <td class="w-25"><input type="text" name="md_mni"
                                                class="border-0 form-control"></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-25"><input type="text" name="mme_rmp"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>23.</td>
                                        <td>Hobbies</td>
                                        <td><input type="text" name="mne_hobbies" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>24.</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="mne_mortgage" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>27.</td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="mne_pl2"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-end pe-lg-3">TOTAL MONTHLY EXPENSES (<span
                                                class="small_text">Add lines 1-31</span>)</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t1"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao1" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt1" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t2"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt2" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t3"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao3" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt3" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t4"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao4" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt4" class="border-0 form-control">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t5"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao5" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt5" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t6"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao6" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt6" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t7"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao7" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt7" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t8"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao8" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt8" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t9"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao9" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt9" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t10"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao10" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt10"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t11"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao11" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt11"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t12"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao12" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt12"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ct_t13"
                                                value="Yes"></td>
                                        <td><input type="text" name="asset_ao13" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="asset_evt13"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="automobile_item1"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="automobilesct_at1"
                                                value="Yes"></td>
                                        <td><input type="text" name="automobile_ao1"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="automobile_evt1"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="automobile_item2"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="automobilesct_at2"
                                                value="Yes"></td>
                                        <td><input type="text" name="automobile_ao2"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="automobile_evt2"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="automobile_item3"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="automobilesct_at3"
                                                value="Yes"></td>
                                        <td><input type="text" name="automobile_ao3"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="automobile_evt3"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="automobile_item4"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="automobilesct_at4"
                                                value="Yes"></td>
                                        <td><input type="text" name="automobile_ao4"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="automobile_evt4"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="automobile_item5"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="automobilesct_at5"
                                                value="Yes"></td>
                                        <td><input type="text" name="automobile_ao5"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="automobile_evt5"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center bg-secondary"><b>Life Insurance:</b> <br> Name of
                                            Company & Policy #</td>
                                        <td class="text-center bg-secondary fw-bold">A</td>
                                        <td class="text-center bg-secondary fw-bold">B</td>
                                        <td class="text-center bg-secondary fw-bold">T</td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="li_item1" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="li_wa_t1"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="li_beneficiary1"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="li_amount1" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="li_esv1" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="li_item2" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="li_wa_t2"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="li_beneficiary2"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="li_amount2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="li_esv2" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="li_item3" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="li_wa_t3"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="li_beneficiary3"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="li_amount3" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="li_esv3" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="li_item4" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="li_wa_t4"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="li_beneficiary4"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="li_amount4" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="li_esv4" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="li_item5" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="li_wa_t5"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="li_beneficiary5"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="li_amount5" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="li_esv5" class="border-0 form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center bg-secondary"><b>Business Interests</b> <br> Name of
                                            Business & Address</td>
                                        <td class="text-center bg-secondary fw-bold">A</td>
                                        <td class="text-center bg-secondary fw-bold">B</td>
                                        <td class="text-center bg-secondary fw-bold">T</td>
                                        <td colspan="3" class="text-center bg-secondary fw-bold">Type of Business
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="bi_noc1" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="bi_ti"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="bi_tob1"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="bi_ownership1"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="bi_vmi1" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="bi_noc2" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="bi_t2"
                                                value="Yes"></td>
                                        <td colspan="3"><input type="text" name="bi_tob2"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="bi_ownership2"
                                                class="border-0 form-control"></td>
                                        <td><input type="text" name="bi_vmi2" class="border-0 form-control">
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td rowspan="2" class="small_text px-1">
                                            <div class="text-center fw-bold"> Securities: Stocks, Bonds, Mutual Funds,
                                                Commodity Accounts</div>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="value_today0"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name1"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t1"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_1"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name2"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t2"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_2"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name3"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t3"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_3"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name4"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t4"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_4"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name5"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t5"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_5"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="company_name6"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="ot_t6"
                                                value="Yes"></td>
                                        <td><input type="text" name="value_today_6"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="text" name="pa_noc1" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="pa_noc2" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="pa_noc3" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="pa_noc4" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="pa_noc5" class="border-0 form-control">
                                        </td>
                                        <td class="text-center"><input type="checkbox" name="pa_a5"
                                                value="Yes"></td>
                                        <td class="text-center"><input type="checkbox" name="pa_b5"
                                                value="Yes"></td>
                                        <td class="text-center"><input type="checkbox" name="pa_t5"
                                                value="Yes"></td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="cad_nob1" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="cad_t1"
                                                value="Yes"></td>
                                        <td><input type="text" name="cad_toa1" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_ald1" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_bt1" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="cad_nob2" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="cad_t2"
                                                value="Yes"></td>
                                        <td><input type="text" name="cad_toa2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_ald2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_bt2" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="cad_nob3" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="cad_t3"
                                                value="Yes"></td>
                                        <td><input type="text" name="cad_toa3" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_ald3" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_bt3" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="cad_nob4" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="cad_t4"
                                                value="Yes"></td>
                                        <td><input type="text" name="cad_toa4" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_ald4" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="cad_bt4" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="op_doa1" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="op_t1"
                                                value="Yes"></td>
                                        <td><input type="text" name="op_top1" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="op_v1" class="border-0 form-control">
                                        </td>

                                    </tr>

                                    <tr>
                                        <td><input type="text" name="op_doa2" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="op_t2"
                                                value="Yes"></td>
                                        <td><input type="text" name="op_top2" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="op_v2" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="op_doa3" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="op_t3"
                                                value="Yes"></td>
                                        <td><input type="text" name="op_top3" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="op_v3" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="op_doa4" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="op_t4"
                                                value="Yes"></td>
                                        <td><input type="text" name="op_top4" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="op_v4" class="border-0 form-control">
                                        </td>

                                    </tr>
                                    <tr>
                                        <td><input type="text" name="op_doa5" class="border-0 form-control">
                                        </td>
                                        ...
                                        <td class="text-center"><input type="checkbox" name="op_t5"
                                                value="Yes"></td>
                                        <td><input type="text" name="op_top5" class="border-0 form-control">
                                        </td>
                                        <td><input type="text" name="op_v5" class="border-0 form-control">
                                        </td>
                    ...
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    <tr>
                                        <td><input type="text" name="op_doa6" class="border-0 form-control">
                                        </td>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class=" bg-secondary small_text ext-center" colspan="3"> Ownership
                                        </td>
                                        <td class=" bg-secondary small_text ext-center" colspan="3"> Acquired by
                                        </td>
                                        <td rowspan="3" class="text-center bg-secondary small_text">Date Acquired
                                        </td>
                                        <td rowspan="3" class="text-center bg-secondary small_text">Value Today
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="aa_doa1"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="aa_doa2"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="aa_doa3"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="aa_doa4"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td colspan="2"><input type="text" name="aa_doa5"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="top1" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="top2" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="top3" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Address: Street, City, State</td>
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="ascs1" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="ascs2" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="ascs3" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="cfmv1" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="cfmv2" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="cfmv3" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Current Mortgage Balance</td>
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="cmb1" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="cmb2" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="cmb3" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Other Liens</td>
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="ol1" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="ol2" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="ol3" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="ol4" class="border-0 form-control">
                                        </td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="ol5" class="border-0 form-control"></td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="ol6" class="border-0 form-control"></td>
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="ol7" class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="text" name="ol8" class="border-0 form-control">
                                        </td>
                                        <td colspan="2" class="text-center"><input type="text"
                                                name="ol9" class="border-0 form-control"></td>
                                        <td colspan="3" class="text-center"><input type="text"
                                                name="ol10" class="border-0 form-control"></td>
                                        <td colspan="4" class="text-center"><input type="text"
                                                name="ol11" class="border-0 form-control"></td>
                                    </tr>
                        ...
                        <div class="row ms-lg-3">
                            ...
                            <div class="col-lg-11">
                                <div>MEDICAL, HOMEOWNERS/RENTERS, AUTOMOBILE, OTHER INSURANCE What type of insurance
                                    policies do you have?</div>
                        ...
                        <div class="table-responsive ps-lg-3">
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="text" name="mh_noc1" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="mh_noc2" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="mh_noc3" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="mh_noc4" class="border-0 form-control">
                                        </td>
                                    ...
                                    <tr>
                                        <td><input type="text" name="mh_noc5" class="border-0 form-control">
                                        </td>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center ">B</td>
                                        <td class="text-center ">T</td>
                                        <td class="text-center"><input type="text" name="d_mp_1"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb_1"
                                                class="border-0 form-control"></td>
                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn1"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too1"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t1"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp1"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb1"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn2"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too2"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t2"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp2"
                                                class="border-0 form-control"></td>
                                    ...
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn3"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too3"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t3"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp3"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb3"
                                                class="border-0 form-control"></td>
                        ...
                        <div class="table-responsive ps-lg-3">
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn4"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too4"
                                                class="border-0 form-control"></td>
                                        <td class="text-center "><input type="checkbox" name="d_a4"
                                                class=""></td>
                                        <td class="text-center "><input type="checkbox" name="d_b4"
                                                class=""></td>
                                        <td class="text-center "><input type="checkbox" name="d_t4"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp4"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb4"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn5"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too5"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t5"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp5"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb5"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn6"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too6"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t6"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp6"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb6"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn7"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too7"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t7"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp7"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb7"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn8"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too8"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t8"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp8"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb8"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn9"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too9"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t9"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp9"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb9"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn10"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too10"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t10"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp10"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb10"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn11"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too11"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t11"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp11"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb11"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn12"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too12"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t12"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp12"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb12"
                                                class="border-0 form-control"></td>

                                    </tr>
                                    <tr>
                                        <td class="text-center"><input type="text" name="d_cn13"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_too13"
                                                class="border-0 form-control"></td>
                                        ...
                                        <td class="text-center "><input type="checkbox" name="d_t13"
                                                class=""></td>
                                        <td class="text-center"><input type="text" name="d_mp13"
                                                class="border-0 form-control"></td>
                                        <td class="text-center"><input type="text" name="d_cb13"
                                                class="border-0 form-control"></td>
