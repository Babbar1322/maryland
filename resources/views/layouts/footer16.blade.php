<div class="row pb-5 pt-3 ">
    {{-- <div class="{{$page == 15 ? 'col-sm-9':'col-lg-12 '}}"  >
        ...
        (10/21)</div> --}}
      <div class="{{$page == 7 ? 'col-lg-6':'col-lg-6  '}}"> FA-4139V, 12/22 Financial Disclosure Statement</div>
      <div class="{{$page == 7 ? 'col-lg-6':'col-lg-6  '}} text-end" > §767.127, Wisconsin Statutes</div>
