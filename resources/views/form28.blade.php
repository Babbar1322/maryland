                            ...
                            <div class="text-center">(Short form)</div>
                                        ...
                                        <div class="d-flex d_sm_block justify-content-between">
                                            <div class="w-75 responsive_input">
                                                <input type="text" name="PlaintiffPetitioner" id="" class="border-0 border-bottom w-75 responsive_input">
                                                <div class="small_text text-center">Plaintiff/Petitioner</div>
                                            </div>
                                            <div> V. </div>
                                            <div class="w-75  responsive_input  text-end">
                                                <input type="text" name="DefendantPetitioner" id="" class="border-0 border-bottom w-75  responsive_input ">
                                ...
                                <div class="ps-lg-5">
                                    ...
                                    <div class="d-flex d_sm_block pt-lg-1 small_text">
                                        <div>Address</div>
                                        <div>
                                            <input type="text" name="Address" id="" class="border-0 border-bottom responsive_input" style="width:473px;">
                                            <div class="text-center">(Street address)</div>

                                        </div>
                                        <div class="ms-lg-3">
                                            <input type="text" name="CityTown" id="" class="border-0 border-bottom responsive_input" style="width:320px;">
                                    ...
                                    <div class="d-flex d_sm_block pt-lg-1 small_text">
                                        ...
                                        <div>
                                            <input type="text" name="Employer address" id="" class="border-0 border-bottom responsive_input" style="width:400px;">
                                            <div class="text-center">(Street address)</div>

                                        </div>
                                        <div class="ms-lg-3">
                                            <input type="text" name="CityTown_2" id="" class="border-0 border-bottom responsive_input" style="width:312px;">
                                            <div class="text-center">(City/Town)</div>
                                        </div>
                                        <div class="ms-lg-3">
                                            <div class="text-center">(State)</div>
                                            <input type="text" name="State_2" id="" class="border-0 border-bottom responsive_input"  style="width:120px;">
                                        </div>
                                        <div class="ms-lg-3">
                                        <input type="text" name="Zip_2" id="" class="border-0 border-bottom responsive_input"style="width:120px;" >
                                            <div class="text-center">(Zip)</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex d_sm_block pt-lg-1 small_text">
                                        <div>Tel. No.</div>
                                        <div><input type="number" name="Tel No_2" id="" class="border-0 border-bottom responsive_input" style="width:708px"></div>
                                        <div>Do you have health insurance coverage?</div>
                                        <div><input type="radio" name="Do you have health insurance coverage" value="Yes" id="" class="mx-2"> <span>Yes</span></div>
                                        <div><input type="radio" name="Do you have health insurance coverage" value="No" id="" class="mx-2"> <span>No</span></div>
                                    </div>

                                    <div class="d-flex d_sm_block pt-lg-1 small_text">
                                        <div>if yes, name of health insurance provider</div>
                                        <div><input type="text" name="if yes name of health insurance provider" id="" class="border-0 border-bottom responsive_input" style="width:862px"></div>
                                ...
                                <div class="ps-lg-5 pt-lg-1 small_text">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div> a) Base pay from  <input type="checkbox"  value="Yes"  name="Salary" class="mx-1" id=""> <span>Salary</span>    <input type="checkbox" name="Wages"  value="Yes"  class="mx-1" id=""> <span>Wages</span></div>
                                        </div>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="d-flex d_sm_block"> k) <input type="checkbox" value="Yes"  name="Disability" id="" class="ms-lg-3 me-1">
                                                ...
                                                <input type="checkbox" value="Yes"  name="Workers compensation"  id="" class="ms-lg-3 me-1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="d-flex d_sm_block"> m) <input type="checkbox" value="Yes"  name="Child Support" id="" class="ms-lg-3 me-1">
                                                ...
                                                <input type="checkbox" value="Yes"  name="Alimony actually received"  id="" class="ms-lg-3 me-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex justify-content-md-end">
                                                <div>$</div>
                                                <div class="responsive_input"><input type="number" name="undefined_14" class="border-0 border-bottom responsive_input"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class=" ">
                            ...
                            <div class="d-flex d_sm_block justify-content-between">
                                <div class="d-flex d_sm_block my-auto">
                                    <span>Division: </span>
                                    <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="Division_2">
                                </div>
                                <div class="d_sm_block">
                                    <div class="fw-bold text-center">Commonwealth of Massachusetts <br>The Trial Court <br> Probate and Family Court Department <br> FINANCIAL STATEMENT </div>
                                </div>
                                <div class="d-flex d_sm_block my-auto">
                                    <span>Docket No.</span>
                                    <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="Docket No_2">
                                </div>
                            </div>
                            <div class="text-center">(Short form)</div>
                            ...
                            <div class="ps-lg-5 pt-lg-1 small_text">
                                <div class="row  mt-lg-1">
                                    <div class="col-lg-8 ">
                                        <div>a) Federal income tax deductions (claiming  <input type="text" name="a Federal income tax deductions claiming" id="" class="border-0 border-bottom"> exemptions) </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>$</div>
                                            <div class="responsive_input"><input type="number" name="undefined_20" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  mt-lg-1">
                                    <div class="col-lg-8 ">
                                        <div>b) State income tax deductions (claiming  <input type="text" name="b State income tax deductions claiming" id="" class="border-0 border-bottom"> exemptions) </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>$</div>
                                            <div class="responsive_input"><input type="number" name="undefined_21" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  mt-lg-1">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>$</div>
                                            <div class="responsive_input"><input type="number" name="undefined_22" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  mt-lg-1">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>$</div>
                                            <div class="responsive_input"><input type="number" name="undefined_23" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row  mt-lg-1">
                            ...
                            <div class="ps-lg-5 pt-lg-1 small_text">
                                ...
                                <div class="row  mt-lg-1">
                                    <div class="col-lg-8">
                                        <div>d) Other-Specify (i.e. Child Support, Deferred Compensation or 401K) <input type="text" name="d OtherSpecify ie Child Support Deferred Compensation or 401K" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>$</div>
                            ...
                            <div class="row  mt-lg-1 small_text">
                                <div class="col-lg-8 ps-lg-5">
                                    ...
                                    <div class="pt-2 ps-lg-5 fw-bold">Number of Years you have paid into Social Security <input type="text" name="Number of Years you have paid into Social Security" id="" class="border-0 border-bottom"></div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                            ...
                            <div class="row small_text">
                                <div class="col-lg-6 ps-lg-5">
                                    <div class="d-flex justify-content-between d_sm_block ">
                                        <div>a) Rent or Mortage (PIT)</div>
                                         <div class="d-flex"><div>$</div><input type="text" name="undefined_34" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>b) Homeowners/Tenant Insurance</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 1" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>c) Maintenance and Repair</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 2" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>d) Heat</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 3" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>e) Electricity and/or Gas</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 4" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>f) Telephone</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 5" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>g) Water/Sewer</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 6" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>h) Food</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 7" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>i) House Supplies</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 8" class="border-0 border-bottom responsive_input"></div>
                                    </div>

                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>j) Laundry and Cleaning</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 0" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>k) Clothing</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="b HomeownersTenant Insurance 10" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                ...
                                <div class="col-lg-6 ps-lg-5">
                                    <div class="d-flex justify-content-between d_sm_block">
                                        ...
                                        <div class="d-flex"><div>$</div><input type="text" name="1" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>m) Medical Insurance</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="2" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>n) Uninsured Medicals</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="3" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>o) Incidentals and Toiletries</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="4" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>p) Motor Vehicle Expenses</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="5" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>q) Motor Vehicle Payment</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="6" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div>r) Child Care</div>
                                        <div class="d-flex"><div>$</div><input type="text" name="7" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                    ...
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div><input type="text" name="s Other explain 1" class="border-0 border-bottom responsive_input"></div>
                                        <div class="d-flex"><div>$</div><input type="text" name="1_2" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                    <div class="d-flex justify-content-between d_sm_block">
                                        <div><input type="text" name="s Other explain 1" class="border-0 border-bottom responsive_input"></div>
                                        <div class="d-flex"><div>$</div><input type="text" name="2_2" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between  pt-lg-2">
                                    <div class="fw-bold mx-auto ">t) Total Weekly Expenses (a through s)</div>
                                    <div class="d-flex justify-content-end">$<input type="text" name="undefined_35" class="border-0 border-bottom responsive_input"></div>
                                </div>
                            </div>
                            ...
                            <div class="ps-lg-5 small_text">
                                <div class="d-flex justify-content-between d_sm_block ">
                                    ...
                                    <div class="d-flex"><div>$</div><input type="number" name="1_3" class="border-0 border-bottom responsive_input"></div>
                                </div>
                                <div class="d-flex justify-content-between d_sm_block ">
                                    <div>b) Legal fees incurred, to date, against retainer(s)</div>
                                    <div class="d-flex"><div>$</div><input type="number" name="2_3" class="border-0 border-bottom responsive_input"></div>
                                </div>
                                <div class="d-flex justify-content-between d_sm_block ">
                                    <div>c) Anticipated range of total legal expense to litigate this action</div>
                                    <div class="d-flex">
                                        <div>$</div><input type="number" name="undefined_36" class="border-0 border-bottom responsive_input me-2"> to <div class="ms-2">$</div><input type="number" name="to" class="border-0 border-bottom responsive_input ">
                                    </div>                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="">
                            <div class="d-flex d_sm_block justify-content-between">
                                <div class="d-flex d_sm_block my-auto">
                                    <span>Division: </span>
                                    <input type="text" class="border-none border-0 border-bottom responsive_input shadow-none my-auto responsive_input" name="Division_3">
                                </div>
                                <div class="d_sm_block">
                                    <div class="fw-bold text-center">Commonwealth of Massachusetts <br>The Trial Court <br> Probate and Family Court Department <br> FINANCIAL STATEMENT </div>
                                </div>
                            ...
                            <div class="ps-lg-5 small_text">
                                ...
                                <div class="row ps-lg-3">
                                    <div class="col-lg-8">
                                        <div>Location <input type="text" name="Location" id="" class="border-0 border-bottom responsive_input" style="width:669px;"></div>
                                    </div>
                                ...
                                <div class="row ps-lg-3">
                                    ...
                                    <div class="row ps-lg-3">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex justify-content-md-end">
                                                <div>=Equity $</div>
                                                <div  class=" w-80"><input type="number" name="undefined_37" class="border-0 border-bottom responsive_input"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row ps-lg-3">
                                    ...
                                    <div class="col-lg-4">
                                        <div> - Motor Vehicle Loan $<input type="text" name="Motor Vehicle Loan" id="" class="border-0 border-bottom responsive_input" style="width:191px                                                                                                                                    ;"></div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>=Equity $</div>
                                            <div  class=" w-80"><input type="number" name="undefined_38" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row ps-lg-3">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex justify-content-md-end">
                                            <div>=Equity $</div>
                                            <div  class=" w-80"><input type="number" name="undefined_39" class="border-0 border-bottom responsive_input"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div> <input type="text" name="Financial Institution or Plan Name and Account Number 1" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>
                            ...
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div> <input type="text" name="Financial Institution or Plan Name and Account Number 2" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>
                            ...
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div><input type="text" name="Financial Institution or Plan Name and Account Number 3" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>

                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                                        <div class="responsive_input"><input type="number" name="undefined_42" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-lg-8  mt-lg-1">
                                    <div>d) Tax Deferred Annuity Plan(s)</div>
                                </div>

                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                                        <div class="responsive_input"><input type="number" name="undefined_43" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                                        <div class="responsive_input"><input type="number" name="undefined_44" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ps-lg-3">
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                                        <div  class="responsive_input"><input type="number" name="undefined_45" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div class="responsive_input"><input type="text" name="Financial Institution or Plan Name and Account Number 3" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                            ...
                            <div class="row pt-lg-1">
                                ...
                                {{-- <div class="col-lg-4">
                                    <div class="d-flex justify-content-md-end">
                                        <div>$</div>
                                        <div class="responsive_input"><input type="number" name="1_4" class="border-0 border-bottom responsive_input"></div>
                                    </div>
                                </div> --}}
                            </div>
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div class="responsive_input"> <input type="text" name="1_4" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>
                            ...
                            <div class="row ps-lg-3">
                                <div class="col-lg-8">
                                    <div  class="responsive_input">   <input type="text" name="2_4" id="" class="border-0 border-bottom responsive_input w-100" ></div>
                                </div>
                            ...
                            <table class="table table-bordered border-dark">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="CreditorRow1" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Nature of DebtRow1" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Date IncurredRow1" id="" class="border-0 w-100"></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_48" id="" class="border-0 w-100"></div></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_45" id="" class="border-0 w-100"></div></td>
                                    </tr>

                                    <tr>
                                        <td class="text-center px-2">b)</td>
                                        <td><input type="text" name="Creditorb" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Nature of Debtb" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Date Incurredb" id="" class="border-0 w-100"></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_49" id="" class="border-0 w-100"></div></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_46" id="" class="border-0 w-100"></div></td>
                                    </tr>
                                    <tr>
                                        <td class="text-center px-2">c)</td>
                                        <td><input type="text" name="Creditorc" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Nature of Debtc" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Date Incurredc" id="" class="border-0 w-100"></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_49" id="" class="border-0 w-100"></div></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_47" id="" class="border-0 w-100"></div></td>
                                    </tr>
                                    <tr>
                                        <td class="text-center px-2">d)</td>
                                        <td><input type="text" name="CreditorRow4" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Nature of DebtRow4" id="" class="border-0 w-100"></td>
                                        <td><input type="text" name="Date IncurredRow4" id="" class="border-0 w-100"></td>
                                        <td><div class="d-flex">$<input type="text" name="fill_51" id="" class="border-0 w-100"></div></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-end  fw-bold"> <div class="border border-dark p-1 d-inline d_sm_block">$ <input type="text" name="fill_52" class="border-0 "></div>  <div class="border border-dark p-1 mt-3 mt-md-0  d-inline d_sm_block">$ <input type="text" name="fill_53" class="border-0 "></div></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class=" ">
                            ...
                            <div class="mt-5 text-center"><b class="border-bottom">INSTRUCTIONS</b>: In any case where an attorney is appearing for a party, said attorney
                                ...
                                <div class="row small_text mb-lg-5">
                                    <div class="col-lg-4">Date <input type="date" name="Date_2" id="" class="border-0 border-bottom" style="width:335px;"></div>
                                    <div class="col-lg-3"></div>
                                    <div class="col-lg-5 ">
                                        <div>
                                            <input type="text" name="undefined_51" id="" class="border-0 border-bottom w-100 responsive_input">
                                        ...
                                        <div class="d-flex d_sm_block pt-lg-1 small_text">
                                            ...
                                            <div class="">
                                                <input type="text" name="CityTown_3" id="" class="border-0 border-bottom responsive_input" style="width:203px;">
                                                <div class="text-center">(City/Town)</div>
                                            </div>
                                            <div class="ms-lg-3">
                                        ...
                                        <div class="pt-lg-2">Tel. No.<input type="number" name="Tel No_3" id="" class="border-0 border-bottom responsive_input" style="width:424px;">
