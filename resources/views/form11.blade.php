            ...
            <form action="{{ route('form9.submit') }}" method="post">
                ...
                <section class="section_area">
                    ...
                    <div class="px-lg-5 px-2  pt-0 row">
                        <div class="text-center"> See Instructions on page 5 for information about completing this form. For additional space , use Continuation of Property Declaration</div>
                        ...
                        <table class="table-bordered border border-2 border-dark">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text"> REAL ESTATE
                                        <input type="text" name="brif_desc1" class="w-100  border-0">
                                ...
                                <tr>
                                    ...
                                    <td class="small_text"> HOUSEHOLD FURNITURE, FURNISHINGS, APPLIANCES
                                        <input type="text" name="brif_desc2" class="w-100  border-0">
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">JEWELRY, ANTIQUES, ART, COIN COLLECTIONS, ETC

                                        <input type="text" name="brif_desc3" class="w-100  border-0">
                                ...
                                <tr>
                                    ...
                                    <td class="small_text"> VEHICLES, BOATS, TRAILERS
                                        <input type="text" name="brif_desc4" class="w-100  border-0">
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">SAVINGS ACCOUNTS
                                        <input type="text" name="brif_desc5" class="w-100  border-0">
                                ...
                                <tr>
                                    ...
                                    <td class="small_text"> CHECKING ACCOUNTS
                                        <input type="text" name="brif_desc6" class="w-100  border-0">
                                    </td>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text"> STUDENT LOANS
                                       <input type="text" name="debts_show19" class="w-100  border-0"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">
                                        TAXES
                                        <input type="text" name="debts_show20" class="w-100  border-0"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">SUPPORT ARREARAGES
                                         <input type="text" name="debts_show21" class="w-100  border-0"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">
                                        LOANS—UNSECURED
                                        <input type="text" name="debts_show22" class="w-100  border-0"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">
                                        CREDIT CARDS
                                        <input type="text" name="debts_show23" class="w-100  border-0"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="small_text">
                                        OTHER DEBTS
                                        <input type="text" name="debts_show24" class="w-100  border-0"></td>
