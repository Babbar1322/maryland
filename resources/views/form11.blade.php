        ...
        <div class="container bg_color p-lg-3 p-1  ">
                ...
                <section class="section_area" id="first_section">
                    ...
                    <div class="row  px-lg-5 px-2   pt-2">
                        @if (session('success'))
                            <div class="alert alert-success alert-dismissible fade show mt-lg-3">
                            ...
                            <div class="p-2 border-bottom border-dark">
                                ...
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div> <input type="text" name="s_address" class="border-0 table_input ">
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                            ...
                            <div class="p-2 border-bottom border-dark">
                                ...
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div> <input type="text" name="county_of" class="border-0 table_input ">
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="d-flex">
                                        <div class="small_text">STREET ADDRESS:</div>
                                        <div> <input type="text" name="street_address" class="border-0 table_input ">
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    ...
                                    <tr>
                                        <td rowspan="8" class="small_text">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="applince1"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="applince2"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="applince3"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="applince4"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="applince5"
                                                    class="w-100 border-0 table_input">
                                            </div>
                                            <div>
                                                <div> 3. JEWELRY, ANTIQUES, ART, COIN COLLECTIONS, ETC </div>
                                                <input type="text" name="jewel1"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="jewel2"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="jewel3"
                                                    class="w-100 border-0 table_input">
                                            </div>
                                            <div>
                                                <div>4. VEHICLES, BOATS, TRAILERS</div>
                                                <input type="text" name="vehicles1"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="vehicles2"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="vehicles3"
                                                    class="w-100 border-0 table_input">
                                            </div>
                                            <div>
                                                <div>5. SAVINGS ACCOUNTS</div>
                                                <input type="text" name="sav_acc1"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="sav_acc2"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="sav_acc3"
                                                    class="w-100 border-0 table_input">
                                            </div>
                                            <div>
                                                <div>6. CHECKING ACCOUNTS</div>
                                                <input type="text" name="check_acc1"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="check_acc2"
                                                    class="w-100 border-0 table_input">
                                                <input type="text" name="check_acc3"
                                                    class="w-100 border-0 table_input">
                                            </div>
                                        </td>
                                        <td rowspan="8" class="small_text">
                                        ...
                                        <td rowspan="8" class="small_text">
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="app_mark_val1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_mark_val2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_mark_val3"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_mark_val4"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_mark_val5"
                                                    class=" w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="jew_mark_val1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="jew_mark_val2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="jew_mark_val3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="vech_mark_val1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="vech_mark_val2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="vech_mark_val3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="sav_mark_val1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="sav_mark_val2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="sav_mark_val3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="ca_mark_val1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="ca_mark_val2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="ca_mark_val3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                        </td>
                                        <td rowspan="8" class="small_text">
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="app_pio1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_pio2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_pio3"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_pio4"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_pio5"
                                                    class=" w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="jew_pio1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="jew_pio2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="jew_pio3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="vech_pio1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="vech_pio2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="vech_pio3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="sav_pio1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="sav_pio2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="sav_pio3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="ca_pio1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="ca_pio2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="ca_pio3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                        </td>
                                        <td rowspan="8" class="small_text">
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="app_resp1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_resp2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_resp3"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="app_resp4"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="app_resp5"
                                                    class=" w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="jew_resp1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="jew_resp2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="jew_resp3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="vech_resp1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="vech_resp2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="vech_resp3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="sav_resp1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="sav_resp2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="sav_resp3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                            <br>
                                            <div class="small_text">
                                                <input type="text" name="ca_resp1"
                                                    class="w-100 border-0 table_input text-end">
                                                <input type="text" name="ca_resp2"
                                                    class="w-100  border-0 table_input text-end">
                                                <input type="text" name="ca_resp3"
                                                    class="w-100 border-0 table_input text-end">
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table-bordered border border-2 border-dark">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-center">B</td>
                                    <td colspan="3">
                                        <div class="d-flex gap-5 justify-content-center"> <span>C </span> - <span> D
                                            </span> = <span> E </span></div>
                                    </td>
                                    <td colspan="2" class="text-center">F</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            ...
                                            <div><input type="text" name="credit_acc1"
                                                    class="w-100  border-0 table_input"></div>
                                            <div><input type="text" name="credit_acc2"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="credit_acc3"
                                                    class="w-100  border-0 table_input"> </div>
                                        </div>
                                        <div>
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="tax_refund1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_refund2"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>10. LIFT INSURANCE WITH CASH SURRNDER OR LOAN VALUE</div>
                                            <input type="text" name="loan_val1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="loan_val2"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>11. STOCKS, BONDS, SECURED,NOTES, MUTUAL FUNDS</div>
                                            <input type="text" name="mut_funds1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="mut_funds2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="mut_funds3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>12. RETIREMENT AND PENSIONS</div>
                                            <input type="text" name="pensions1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="pensions2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="pensions3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>13. PROFIT-SHARING,IRAS,DEFERRED COMPENSATION ANNUTIES</div>
                                            <input type="text" name="profit_sharing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="profit_sharing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="profit_sharing3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>14. ACCOUNT RECIEVABLE,UNSECURED NOTES</div>
                                            <input type="text" name="acc_rec1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="acc_rec2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="acc_rec3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>15. PARTERSHIP ,OTHER BUSINESS INTEREST</div>
                                            <input type="text" name="bus_int1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="bus_int2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="bus_int3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>16. OTHER ASSETS</div>
                                            <input type="text" name="other_ass1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_ass2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_ass3"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                    ...
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <div><input type="text" name="ca_mark_val1"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_mark_val2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_mark_val2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                            </div>
                                        ...
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="cash_mark_val1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="cash_mark_val2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="tr_mark_val1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="tr_mark_val2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="lv_mark_val1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="lv_mark_val2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="mf_mark_val1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="mf_mark_val2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="mf_mark_val3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="rp_mark_val1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="rp_mark_val2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="rp_mark_val3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ps_mark_val1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ps_mark_val2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ps_mark_val3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ar_mark_val1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ar_mark_val2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ar_mark_val3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="bi_mark_val1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="bi_mark_val2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="bi_mark_val3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="oa_mark_val1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="oa_mark_val2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="oa_mark_val3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="cs_mark_val1"
                                                class="w-100 border-0 table_input">
                                        </div>
                                    </td>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <div><input type="text" name="ca_pio1"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_pio2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_pio2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                            </div>
                                        ...
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="cash_pio1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="cash_pio2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="tr_pio1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="tr_pio2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="lv_pio1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="lv_pio2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="mf_pio1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="mf_pio2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="mf_pio3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="rp_pio1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="rp_pio2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="rp_pio3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ps_pio1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ps_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ps_pio3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ar_pio1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ar_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ar_pio3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="bi_pio1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="bi_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="bi_pio3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="oa_pio1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="oa_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="oa_pio3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="cs_pio1"
                                                class="w-100 border-0 table_input">
                                        </div>
                                    </td>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            ...
                                            <br>
                                            <div class="small_text">
                                                <div><input type="text" name="ca_resp1"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_resp2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                                <div><input type="text" name="ca_resp2"
                                                        class="w-100  border-0 table_input text-end"></div>
                                            </div>
                                        ...
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="cash_resp1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="cash_resp2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="tr_resp1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="tr_resp2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="lv_resp1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="lv_resp2"
                                                class="w-100  border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="mf_resp1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="mf_resp2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="mf_resp3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div class="small_text">
                                            <input type="text" name="rp_resp1"
                                                class="w-100 border-0 table_input text-end">
                                            <input type="text" name="rp_resp2"
                                                class="w-100  border-0 table_input text-end">
                                            <input type="text" name="rp_resp3"
                                                class="w-100 border-0 table_input text-end">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ps_resp1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ps_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ps_resp3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="ar_resp1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="ar_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="ar_resp3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <br>
                                        <div>
                                            <input type="text" name="bi_resp1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="bi_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="bi_resp3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="oa_resp1"
                                                class="w-100 border-0 table_input">
                                            <input type="text" name="oa_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="oa_resp3"
                                                class="w-100 border-0 table_input">
                                        </div>
                                        <br>
                                        <div>
                                            <input type="text" name="cs_resp1"
                                                class="w-100 border-0 table_input">
                                        </div>
                                    </td>
                                </tr>
                ...
                <section class="section_area  px-lg-5 px-2" id="third_section">
                    <div class="table-responsive pt-5">
                                ...
                                <tr>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            ...
                                            <div><input type="text" name="sl1"
                                                    class="w-100  border-0 table_input"></div>
                                            <div><input type="text" name="sl2"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl3"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl4"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl5"
                                                    class="w-100  border-0 table_input"> </div>
                                        </div>
                                        <div>
                                            <div>
                                            ...
                                            <input type="text" name="tax1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>
                                            ...
                                            <input type="text" name="sa1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa3"
                                                class="w-100  border-0 table_input">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="lous1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>23. CREDIT CARDS</div>
                                            <input type="text" name="credit_card1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card6"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <div>24. OTHER DEBTS</div>
                                            <input type="text" name="other_debt1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt6"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt7"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt8"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                    ...
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            <br>
                                            <div><input type="text" name="sl_total_owing1"
                                                    class="w-100  border-0 table_input"></div>
                                            <div><input type="text" name="sl_total_owing2"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_total_owing3"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_total_owing4"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_total_owing5"
                                                    class="w-100  border-0 table_input"> </div>
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="tax_total_owing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_total_owing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_total_owing3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_total_owing4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="sa_total_owing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_total_owing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_total_owing3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_total_owing4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="lous_total_owing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_total_owing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_total_owing3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_total_owing4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="credit_card_total_owing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_total_owing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_total_owing3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_total_owing4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_total_owing5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_total_owing6"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_debt_total_owing1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing6"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing7"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_total_owing8"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_detb_sheet_total_owing"
                                                class="w-100  border-0 table_input">
                                        </div>
                                    </td>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            <br>
                                            <div><input type="text" name="sl_pio1"
                                                    class="w-100  border-0 table_input"></div>
                                            <div><input type="text" name="sl_pio2"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_pio3"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_pio4"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_pio5"
                                                    class="w-100  border-0 table_input"> </div>
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="tax_pio1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_pio3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_pio4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="sa_pio1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_pio3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_pio4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="lous_pio1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_pio3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_pio4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="credit_card_pio1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_pio3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_pio4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_pio5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_pio6"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_debt_pio1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio6"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio7"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_pio8"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_detb_sheet_pio"
                                                class="w-100  border-0 table_input">
                                        </div>
                                    </td>
                                    <td rowspan="8" class="small_text">
                                        <div>
                                            <br>
                                            <div><input type="text" name="sl_resp1"
                                                    class="w-100  border-0 table_input"></div>
                                            <div><input type="text" name="sl_resp2"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_resp3"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_resp4"
                                                    class="w-100  border-0 table_input"> </div>
                                            <div><input type="text" name="sl_resp5"
                                                    class="w-100  border-0 table_input"> </div>
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="tax_resp1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_resp3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="tax_resp4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="sa_resp1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_resp3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="sa_resp4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="lous_resp1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_resp3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="lous_resp4"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="credit_card_resp1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_resp3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_resp4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_resp5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="credit_card_resp6"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_debt_resp1"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp2"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp3"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp4"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp5"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp6"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp7"
                                                class="w-100  border-0 table_input">
                                            <input type="text" name="other_debt_resp8"
                                                class="w-100  border-0 table_input">
                                        </div>
                                        <div>
                                            <br>
                                            <input type="text" name="other_detb_sheet"
                                                class="w-100  border-0 table_input">
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="px-3">
                            <div class="d-flex">
                                <input type="checkbox" class="me-2" name="continuation_declaration"
                                    value="Yes"> A Continuation of Property Declaration (<div class=" "> <a
                                        href="https://www.courts.ca.gov/documents/fl161.pdf" target="_blank">form
                            ...
                            <div class="small_text">I declare under penalty of perjury under the laws of the State of
                                California that, to the best of my knowledge, the foregoing is a true and correct
