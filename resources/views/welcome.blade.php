    ...
    <div class="container">
        <div class="row mx-auto text-center my-5">
            <div class="col-lg-4 col-sm-6 col-12 mt-4 ">
                <a href="{{route('pdf_form1')}}" class="text-decoration-none">
                <div class="card">
            ...
            <div class="col-lg-4 col-sm-6 col-12 mt-4 ">
                <a href="{{route('pdf_form13')}}" class="text-decoration-none">
                 <div class="card">
                     <div class="card-body p-5">
                      <h5 class="text-decoration-none text-dark">Form 13</h5>
            ...
            <div class="col-lg-4 col-sm-6 col-12 mt-4">
                <a href="{{route('pdf_form21')}}" class="text-decoration-none">
                 <div class="card">
                     <div class="card-body p-5">
                      <h5 class="text-decoration-none text-dark">Form 21</h5>
                      <span>WI FA-4139V.pdf</span>
                    </div>
                  </div>
                </a>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 col-12 mt-4">
                <a href="{{route('pdf_form24')}}" class="text-decoration-none">
                 <div class="card">
                     <div class="card-body p-5">
