...
class CreateJudicialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('old_1_md_form_data', function (Blueprint $table) {
            ...
            $table->string("h_others")->nullable();
            ...
            $table->bigInteger("da1")->nullable();
            $table->bigInteger("da2")->nullable();
            $table->bigInteger("da3")->nullable();
            $table->bigInteger("db1")->nullable();
            $table->bigInteger("db2")->nullable();
            $table->bigInteger("db3")->nullable();
            $table->bigInteger("dc1")->nullable();
            $table->bigInteger("dc2")->nullable();
            $table->bigInteger("dc3")->nullable();
            $table->bigInteger("td")->nullable();
            $table->bigInteger("tdoi")->nullable();
            $table->bigInteger("noi")->nullable();
            $table->bigInteger("tmi")->nullable();
            $table->string("gm_others")->nullable();
            ...
            $table->bigInteger("lb_a")->nullable();
            $table->bigInteger("lb_b")->nullable();
            $table->bigInteger("lb_c")->nullable();
            $table->string("lb_other")->nullable();
            $table->bigInteger("lb_tl")->nullable();
